                                ...
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-penelitianaktif">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><center style="width: 100px">Nama</center></th>
                                            <th><center>Instansi</center></th>                           
                                            <th ><center style="width: 150px">Judul Penelitian</center></th>                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                      ...
                      <label>Tanggal Keluar : </label>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="Berkas1[]" value="KTM" />Fotokopi KTM
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                ...
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-penelitian">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><?php echo $data['Keterangan1'];?></center>                             
                                            </td>                                                                          
                                            <td>
