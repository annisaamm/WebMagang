                                ...
                                <div class="col-md-12">
                                	...
                                	<form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kode_jurusan" value="<?php echo $tampil['kode_jurusan'];?>" />
                                        </div>
...
<?php
	...
	if($ubahjurusan) {
		$sql = $koneksi->query("update tb_jurusan set kode_jurusan='$kode_jurusan', nama_jurusan='$nama_jurusan'");
		if ($sql) {
			?>
