                                ...
                                <div class="col-md-12">
                                	...
                                	<form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kode_instansi" value="<?php echo $tampil['kode_instansi'];?>" />
                                        </div>
...
<?php
	...
	if($ubahinstansi) {
		$sql = $koneksi->query("update tb_instansi set kode_instansi='$kode_instansi', nama_instansi='$nama_instansi', alamat_instansi='$alamat_instansi'");
		if ($sql) {
			?>
