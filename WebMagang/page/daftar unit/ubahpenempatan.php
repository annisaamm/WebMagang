                                ...
                                <div class="col-md-12">
                                	...
                                	<form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kode_penempatan" value="<?php echo $tampil['kode_penempatan'];?>" />
                                        </div>
...
<?php
	...
	if($ubahpenempatan) {
		$sql = $koneksi->query("update tb_penempatan set kode_penempatan='$kode_penempatan', nama_penempatan='$nama_penempatan', kuota_penempatan='$kuota_penempatan'");
		if ($sql) {
			?>
