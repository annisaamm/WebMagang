                                ...
                                <div class="col-md-12">
                                	...
                                	<form method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="kode_fakultas" value="<?php echo $tampil['kode_fakultas'];?>" />
                                        </div>
...
<?php
	...
	if($ubahfakultas) {
		$sql = $koneksi->query("update tb_fakultas set kode_fakultas='$kode_fakultas', nama_fakultas='$nama_fakultas'");
		if ($sql) {
			?>
