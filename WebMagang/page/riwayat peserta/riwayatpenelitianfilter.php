                                ...
                                <table class="table table-striped table-bordered table-hover" ID="dataTables-riwayatpenelitian">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $koneksi->query("SELECT * FROM `tb_inputpenelitian` WHERE TanggalMasuk1 and TanggalKeluar1 BETWEEN '".$tanggalawal."' AND '".$tanggalakhir."' ORDER BY TanggalMasuk1 AND TanggalKeluar1");
